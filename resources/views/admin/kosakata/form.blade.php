    ...
    <div class="col-md-12">
            ...
            <select name="category_id" class="form-control @error('category_id') is-invalid @enderror" id="kategori_id">
                ...
                @foreach ($categories as $kategori)
                    <option value="{{ $kategori->id }}"
                        {{ old('category_id', $kosakata->kategori_id ?? '') == $kategori->id ? 'selected' : '' }}>
                        {{ $kategori->name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                value="{{ old('name', $kosakata?->name) }}" id="name" placeholder="Name">
        ...
        <div class="form-group mb-2 mb20">
            ...
            @if ($kosakata && $kosakata->images)
                <div class="mt-2">
                    <img src="{{ asset('assets/kosakata/' . $kosakata->images) }}" alt="Current Image" width="100">
                </div>
            @endif
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="description" class="form-control @error('description') is-invalid @enderror"
                value="{{ old('description', $kosakata?->description) }}" id="description" placeholder="Description">
